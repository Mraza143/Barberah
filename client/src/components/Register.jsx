...
const Register = ({ history }) => {
  ...
  const [avatarPreview, setAvatarPreview] = useState('/images/login_register.jpg')
  //   -------------------------
          ...
          >
            <div className="background-frame w-full mx-auto p-12 mx-12 flex-col items-center space-y-6">
              ...
              <p className="text-white mt-1">
                ...
                consequuntur sit magni perferendis enim! Iste? Lorem ipsum dolor
                sit amet, consectetur adipisicing elit. At repellat natus iste
                aliquam aliquid enim in voluptatibus dicta ducimus ipsa placeat
            ...
            <div className="w-full px-8 md:px-32 lg:px-24">
              ...
              >
                ...
                <div className=" flex items-center  mb-6 py-2 px-3 rounded-2xl pl-0 pr-0 ">
                  <select
                    className=" block w-full px-3 py-1.5 font-normal text-gray-700  border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white  focus:outline-none"
